...
CFG_ICV_NORMAL_NO_SECURE="set config_file config_hci_mode_wounded.conf"
...
PROV_ICV_PATH="set app_folder cyapp_prov_icv/cyw20829/${TARGET_TYPE}"
PROV_OEM_PATH="set app_folder cyapp_hci_debug/cyw20829/${TARGET_TYPE}"
...
printf "===================\n"
echo_run "$OPENOCD_PATH" -s "$OPENOCD_SCRIPT_PATH" -c "$CFG_ICV_NORMAL_NO_SECURE" -c "$PROV_ICV_PATH" -f "$TCL_SCRIPT_PATH"
