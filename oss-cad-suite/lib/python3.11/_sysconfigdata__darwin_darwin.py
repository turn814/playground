...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-ar',
 'ARFLAGS': 'rcs',
 'BASECFLAGS': '-Wsign-compare -Wunreachable-code',
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/yosyshq/bin',
 'BINLIBDEST': '/yosyshq/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang',
 'CCSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/opt/local/include',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/opt/local/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/yosyshq' '--enable-shared' '--with-system-ffi' "
                "'--with-openssl=/opt/local' '--host=x86_64-apple-darwin22.4' "
                "'--build=x86_64-linux-gnu' '--disable-ipv6' "
                "'--with-build-python=/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11' "
                "'build_alias=x86_64-linux-gnu' "
                "'host_alias=x86_64-apple-darwin22.4' "
                "'PKG_CONFIG_PATH=/opt/local/lib/pkgconfig' "
                "'CC=/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang' "
                "'CFLAGS=-I/opt/local/include' 'LDFLAGS=-L/opt/local/lib'",
 'CONFINCLUDEDIR': '/yosyshq/include',
 'CONFINCLUDEPY': '/yosyshq/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/work/_builds/darwin-x64/python3/python3/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/work/_builds/darwin-x64/python3/python3/lcov-report',
 ...
 'CXX': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang++',
 ...
 'DESTDIRS': '/yosyshq /yosyshq/lib /yosyshq/lib/python3.11 '
             '/yosyshq/lib/python3.11/lib-dynload',
 'DESTLIB': '/yosyshq/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/yosyshq/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'FREEZE_MODULE': '/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11 '
                            './Programs/_freeze_module.py',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'x86_64-apple-darwin22.4',
 'INCLDIRSTOMAKE': '/yosyshq/include /yosyshq/include '
                   '/yosyshq/include/python3.11 /yosyshq/include/python3.11',
 'INCLUDEDIR': '/yosyshq/include',
 'INCLUDEPY': '/yosyshq/include/python3.11',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang++ '
                '-bundle -undefined dynamic_lookup',
 'LDFLAGS': '-L/opt/local/lib -L/opt/local/lib',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.dylib',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang '
             '-bundle -undefined dynamic_lookup -L/opt/local/lib '
             '-L/opt/local/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/yosyshq/lib/python3.11',
 'LIBDIR': '/yosyshq/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -g -fwrapv -O3 -Wall -I/opt/local/include '
                    '-I/opt/local/include -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include',
 'LIBM': '',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DUNIVERSAL=1 '
                    '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 '
                    '-Wall -I/opt/local/include -I/opt/local/include -std=c11 '
 ...
 'LIBPL': '/yosyshq/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11.a',
 'LIBRARY_DEPS': 'libpython3.11.a libpython3.11.dylib',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lintl -ldl  -lpthread -framework CoreFoundation',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/yosyshq/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '12.0',
 'MAINCC': '/usr/local/osxcross/target/bin/x86_64-apple-darwin22.4-clang',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include',
 'MODULE_BINASCII_LDFLAGS': '-L/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include',
 'MODULE_ZLIB_LDFLAGS': '-L/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/opt/local/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/opt/local/lib   -lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include',
 'MODULE__LZMA_LDFLAGS': '-L/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include  '
                           '-I./Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/opt/local/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/opt/local/lib  -lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/include  '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/usr/local/osxcross/target/bin/../macports/pkgs/opt/local/lib '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/work/_builds/darwin-x64/python3/python3 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/work/_builds/darwin-x64/python3/python3/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin '
                     '/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha256,sha512,sha3,blake2"',
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -I/opt/local/include '
                             '-I/opt/local/include -std=c11 -Wextra '
 ...
 'PY_CORE_LDFLAGS': '-L/opt/local/lib -L/opt/local/lib',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/local/lib -L/opt/local/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/opt/local/lib -L/opt/local/lib',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
 'PY_SQLITE_HAVE_SERIALIZE': 1,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -I/opt/local/include -I/opt/local/include '
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lintl -ldl  -lpthread -framework CoreFoundation',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/work/_builds/darwin-x64/python3/python3 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/work/_builds/darwin-x64/python3/python3/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/work/_builds/darwin-x64/python3/python3-native/yosyshq/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/work/_builds/darwin-x64/python3/python3 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/work/_builds/darwin-x64/python3/python3/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './yosyshq',
 'WASM_STDLIB': './yosyshq/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/work/_builds/darwin-x64/python3/python3',
 'abs_srcdir': '/work/_builds/darwin-x64/python3/python3',
