...
function(verilate TARGET)
    ...
    if(VERILATOR_OUTDATED)
        ...
        file(
            WRITE ${VDIR}/${VERILATE_PREFIX}.cmake
            "# Verilated -*- CMake -*-\n"
        ...
        if(JNSUBMODULES)
            file(
                APPEND ${VDIR}/${VERILATE_PREFIX}.cmake
            ...
            foreach(I RANGE ${JNSUBMODULES})
                ...
                if(NOT ${I} STREQUAL ${JNSUBMODULES})
                    ...
                    string(
                        APPEND SUBMODULE_VERILATE_ARGS
